...
struct PointLightData {
	...
	PointLightData(glm::vec3 pos, glm::vec3 col, glm::vec3 diff, glm::vec3 spec, float lin, float quad, float inten, bool shadowCast, bool bc = false, utility::GUID bmGUID = utility::GUID{}) :
